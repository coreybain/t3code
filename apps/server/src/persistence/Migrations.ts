...
import Migration0027 from "./Migrations/027_ProjectionThreadsChatMetadata.ts";
import Migration0028 from "./Migrations/028_Tickets.ts";
...
export const migrationEntries = [
  ...
  [27, "ProjectionThreadsChatMetadata", Migration0027],
  [28, "Tickets", Migration0028],
] as const;
