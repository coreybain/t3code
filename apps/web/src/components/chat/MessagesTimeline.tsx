        ...
        (() => {
          ...
          return (
            <div className="group/user-message flex flex-col items-end">
              ...
              <div className="mt-1.5 flex items-center justify-end gap-2 opacity-0 transition-opacity duration-200 focus-within:opacity-100 group-hover/user-message:opacity-100">
