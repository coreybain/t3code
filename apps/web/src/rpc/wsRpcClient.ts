...
export interface WsRpcClient {
  ...
  readonly git: {
    ...
    readonly getDiff: RpcUnaryMethod<typeof WS_METHODS.gitGetDiff>;
  ...
  readonly server: {
    ...
    readonly getUsage: RpcUnaryNoArgMethod<typeof WS_METHODS.serverGetUsage>;
...
export function createWsRpcClient(transport: WsTransport): WsRpcClient {
  return {
    ...
    server: {
      ...
      getUsage: () => transport.request((client) => client[WS_METHODS.serverGetUsage]({})),
